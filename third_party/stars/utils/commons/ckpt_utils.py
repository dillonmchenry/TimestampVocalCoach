...
def load_ckpt(cur_model, ckpt_base_dir, model_name='model', force=True, strict=True, verbose=True, return_steps=False):
    ...
    if checkpoint is not None:
        ...
        if return_steps:
            if 'global_step' in checkpoint:
                ...
                assert False, f"| global_step not found in ckpt."
        if verbose:
